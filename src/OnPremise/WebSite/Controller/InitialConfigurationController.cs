    ...
    public class InitialConfigurationController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var model = new InitialConfigurationModel
            {
                ...
                AvailableCertificates = GetAvailableCertificatesFromCurrentUserStore(),
            ...
            if (ModelState.IsValid)
            {
                ...
                if (model.CreateDefaultAccounts)
                {
                    ...
                    if (errors.Count != 0)
                    {
                        ...
                        model.AvailableCertificates = GetAvailableCertificatesFromCurrentUserStore();
                        return View(model);
                    }
                }
                ...
                try
                {
                    ...
                    var cert = X509.CurrentUser.My.SubjectDistinguishedName.Find(model.SigningCertificate, false).First();
        ...
        private List<string> GetAvailableCertificatesFromCurrentUserStore()
        {
            var list = new List<string>();
